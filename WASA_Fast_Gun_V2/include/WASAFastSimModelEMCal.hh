...
//
//
/// \file WASAFastSimModelEMCal.hh
/// \brief Definition of the WASAFastSimModelEMCal class
...
/// is smeared (by WASASmearer::SmearMomentum()). Based on G4 
/// examples/extended/parametrisations/Par01/include/Par01EMShowerModel.hh .
/// @author Anna Zaborowska

class WASAFastSimModelEMCal : public G4VFastSimulationModel {
  public:
    ...
    WASAFastSimModelEMCal( G4String aModelName, G4Region* aEnvelope, 
    ...
    /// A constructor.
    /// @param aModelName A name of the fast simulation model.
    WASAFastSimModelEMCal( G4String aModelName );

    ~WASAFastSimModelEMCal();
    ...
    /// and efficiency to the WASAPrimaryParticleInformation.
    /// @param aFastTrack A track.
