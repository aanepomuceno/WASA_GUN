...
//
//
/// \file WASAFastSimModelHCal.hh
/// \brief Definition of the WASAFastSimModelHCal class
...
class WASAFastSimModelHCal : public G4VFastSimulationModel {
  public:
    ...
    WASAFastSimModelHCal( G4String aModelName, G4Region* aEnvelope, 
    ...
    /// A constructor.
    /// @param aModelName A name of the fast simulation model.
    WASAFastSimModelHCal( G4String aModelName );

    ~WASAFastSimModelHCal();
    ...
    /// efficiency to the WASAPrimaryParticleInformation.
    /// @param aFastTrack A track.
