...
//
//
/// \file WASAEventAction.hh
/// \brief Definition of the WASAEventAction class
...
class WASAEventAction : public G4UserEventAction {
  public:
    ...
    WASAEventAction( G4bool aSmear );

    virtual ~WASAEventAction();

    /// Defines the actions at the beginning of the event. 
    /// It sets the WASAEventInformation with fSmear flag. 
    /// It creates all the ntuples defined in WASAOutput singleton class.
  ...
  private:
    ...
    /// Passed to WASAEventInformation in BeginOfEventAction(const G4Event*).
    G4bool fSmear;
};
