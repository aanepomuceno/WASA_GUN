...
//
//
/// \file WASAPrimaryParticleInformation.cc
/// \brief Implementation of the WASAPrimaryParticleInformation class

#include "WASAPrimaryParticleInformation.hh"

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

WASAPrimaryParticleInformation::WASAPrimaryParticleInformation( 
  G4int aPartID, G4int aPDG, G4double aKineticEnergy, G4ThreeVector aMomentum, G4ThreeVector aMCPosition ) : 
  fPartID( aPartID ), fPDG( aPDG ), fKEnergyMC(aKineticEnergy), fMomentumMC( aMomentum ), fPositionMC (aMCPosition),
...
void WASAPrimaryParticleInformation::Print() const {
  G4cout << "WASAPrimaryParticleInformation: PDG code " << fPDG << G4endl
