...
//       because the histogram manager - i.e. the class WASAOutput -
//       is a singleton...
//
//-------------------------------------------------------------------
...
int main( int argc, char** argv ) {
  ...
  G4VUserPhysicsList* physicsList = new WASAPhysicsList;
  runManager->SetUserInitialization( physicsList );

  //-------------------------------
  // UserAction classes
  //-------------------------------
  runManager->SetUserInitialization( new WASAActionInitialization );
