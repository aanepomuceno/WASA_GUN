...
//
//
/// \file WASATrackingAction.hh
/// \brief Definition of the WASATrackingAction class
...
class WASATrackingAction : public G4UserTrackingAction {
  public:
    
    /// A default constructor.
    WASATrackingAction();

    virtual ~WASATrackingAction();
