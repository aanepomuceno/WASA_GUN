...
//
//
/// \file WASAFastSimModelTracker.hh
/// \brief Definition of the WASAFastSimModelTracker class
...
/// (by WASASmearer::SmearMomentum()) and the particle is placed at the
...
class WASAFastSimModelTracker : public G4VFastSimulationModel {
  public:
    ...
    WASAFastSimModelTracker( G4String aModelName, G4Region* aEnvelope, 
                         WASADetectorParametrisation::Parametrisation aParamType );
    ...
    /// A constructor.
    /// @param aModelName A name of the fast simulation model.
    WASAFastSimModelTracker( G4String aModelName );

    ~WASAFastSimModelTracker();
    ...
    /// resolution and efficiency to the WASAPrimaryParticleInformation.
    /// @param aFastTrack A track.
  ...
  private:
    ...
    /// A pointer to WASADetectorParametrisation used to get the efficiency and
    /// resolution of the tracking detector for a given particle and
    /// parametrisation type.
    WASADetectorParametrisation* fCalculateParametrisation;
    
    /// A parametrisation type.
    WASADetectorParametrisation::Parametrisation fParametrisation;
};
