...
//
//
/// \file WASAPrimaryParticleInformation.hh
/// \brief Definition of the WASAPrimaryParticleInformation class
...
class WASAPrimaryParticleInformation : public G4VUserPrimaryParticleInformation {
  public:
    ...
    WASAPrimaryParticleInformation( G4int aID, G4int aPDG, G4double aKineticEnergy, G4ThreeVector aMomentum, G4ThreeVector aMCPosition );

    virtual ~WASAPrimaryParticleInformation();
    ...
    /// Gets the initial particle position (from particle generator).
    inline G4ThreeVector GetMCPosition() { return fPositionMC; };
    
    /// Gets the initial particle kinetic energy (from particle generator).
    inline G4double GetMCKineticEnergy() { return fKEnergyMC; };
  ...
  private:
    ...
    /// A particle initial position (from particle generator).
    G4ThreeVector fPositionMC;
    
    /// A particle initial kinetic energy (from particle generator).
    G4double fKEnergyMC;
