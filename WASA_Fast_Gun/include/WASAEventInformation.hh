...
//
//
/// \file WASAEventInformation.hh
/// \brief Definition of the WASAEventInformation class
...
class WASAEventInformation : public G4VUserEventInformation {
  public:
    
    /// A default constructor. Sets flag fDoSmearing to true.
    WASAEventInformation();
    
    /// A constructor.
    /// @param aSmear The flag indicating if smearing should be done.
    WASAEventInformation( G4bool aSmear );

    virtual ~WASAEventInformation();
